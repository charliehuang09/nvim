return {
  ...
  config = function()
    ...
    local grep_file_in_current_directory = function()
      local dir = vim.fn.expand('%'):gsub("oil://", "")
    ...
    keymap.set('n', '<leader>ff', function() grep_file_in_current_directory() end,
      { desc = "Fuzzy find in current directory" })
    keymap.set("n", "<leader>fg", function() grep_file_content_in_current_directory() end,
